...
//		executor.executeScript("arguments[0].click();", element);
		explicitWaitStatement("xpath", prop_lang.getProperty("xpath.AppLauncher"));
		clickElementUsingJavaScript(locateElement("xpath", prop_lang.getProperty("xpath.AppLauncher")));
        return this;
	}
	...
	public A2_HomePage clickViewAll() {
		...
		click(locateElement("xpath",prop_lang.getProperty("xpath.viewAll")));
        return this;
	}
	...
	locateElement("xpath",prop_lang.getProperty("xpath_Entersales")).sendKeys("Sales");
		Thread.sleep(2000);
		return this;
...
//		executor1.executeScript("arguments[0].click();", element1);	
	...
	//locateElement("xpath",prop_lang.getProperty("xpath_clicksales"));
	clickElementUsingJavaScript(locateElement("xpath",prop_lang.getProperty("xpath_clicksales")));
		Thread.sleep(2000);
        return this;
	}
...
//		executor2.executeScript("arguments[0].click();", element2);
		...
		//locateElement("xpath",prop_lang.getProperty("xpath_Clickopportunities"));
		clickElementUsingJavaScript(locateElement("xpath",prop_lang.getProperty("xpath_Clickopportunities")));	
...
//		executor3.executeScript("arguments[0].click();", element3);
		//locateElement("xpath",prop_lang.getProperty("xpath_Clickaccounts"));
		clickElementUsingJavaScript(locateElement("xpath",prop_lang.getProperty("xpath_Clickaccounts")));	
